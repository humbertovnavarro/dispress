import { percentageToProgressBar, progressBarBackgroundCharacter, progressBarForegroundCharacter } from './TrackEmbed';
describe("Track Embed", () => {
    test("progress bar", () => {
        const expected = `${progressBarForegroundCharacter.repeat(12)}${progressBarBackgroundCharacter.repeat(12)}`
